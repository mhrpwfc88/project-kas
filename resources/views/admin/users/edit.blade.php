                ...
                <div id='recipients' class="p-8 mt-6 lg:mt-0 text-white dark:bg-gray-800 rounded shadow">
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" id="name" name="name" value="{{ old('name', $user->name) }}" class="form-input block w-full text-black focus:bg-gray-500 rounded-md">
                                @error('name')
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}" class="form-input block w-full text-black focus:bg-gray-500 rounded-md">
                                @error('email')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="password" id="password" name="password" class="form-input block w-full text-black focus:bg-gray-500 rounded-md" placeholder="Kosongkan jika tidak ingin mengubah">
                                @error('password')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
